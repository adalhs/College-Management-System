...
Public Class Admissions
    ...
    Private Sub FormAdmisions_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'Textbox and combobox (dropdownlists) controls disabled when form loads
    ...
    'Opens form controls so user can enter information
    ...
    Private Sub btnSubmitInfo_Click(sender As Object, e As EventArgs) Handles btnSubmitInfo.Click
        ...
        'Sets the color of labels of empty required fields to red
        If txtFirstName.Text = "" Or
           txtLastName.Text = "" Or
           txtAge.Text = "" Or
           txtAddress.Text = "" Or
           ddlSex.Text = "Choose one option:" Or
           txtCity.Text = "" Or
           (ddlState.Text = "Choose one option:" And ddlCountry.Text = "United States") Or
           txtZipcode.Text = "" Or
           ddlCountry.Text = "Choose one option:" Or
           ddlMajor.Text = "Choose one option:" Or
           ddlCovid.Text = "Choose one option:" Then
    ...
    'INSERTS new student info into table and generates a random code for their PersonId, making sure it isn't already in the Person table
    ...
    'UPDATEs a record on the Person table
    Public Sub UpdateStudentInfo()
        ...
        sqlConn.Open()
        sqlCmd.Connection = sqlConn
        sqlCmd.CommandText = "UPDATE Person SET FirstName = '" & txtFirstName.Text & "',
        ...
        HouseIncome = '" & txtIncome.Text & "',
        Major = '" & ddlMajor.Text & "',
        Vaccination = '" & ddlCovid.Text & "'
    ...
    'Sets the color of labels of empty required fields to red
    Private Sub RequiredFieldEmpty()
        If txtFirstName.Text = "" Or
           txtLastName.Text = "" Or
           txtAge.Text = "" Or
           txtAddress.Text = "" Or
