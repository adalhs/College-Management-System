...
Public Class AdmissionsEnterStudent
    ...
    Dim sqlTable As New DataTable   'invisible table used in the EnterStudentInfo Sub to hold temporary data to see if randomid is already a PersonId in Person table
